  ...
  async exec() {
    ...
    try {
      ...
      if (this.engine.isDry) {
        console.info('[dry]', 'stop service: systemctl --user stop marvin');
        console.info('[dry]', 'disable service: systemctl --user disable marvin');
      } else {
      ...
      console.info('marvin is now inactive');
    }
